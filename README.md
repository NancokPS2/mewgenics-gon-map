...
- target: Denotes the tiles that will be targeted when this is aimed.
  - max_aoe(num): How big the AoE can be (i assume this is a diamond-shaped area by default)
...
### Effects
These all take numbers as their value. The number denotes their stacks unless stated otherwise.
- Sleep
- Shield
