...
These are just simpler JSON. Only supports character identings (the "s are optional) and numbers only. Line breaks denote ends of line. {}s are still used to denote scopes. 
